...
import com.zequence.ZequenceIms.dto.LoginAttemptResponse;
import com.zequence.ZequenceIms.dto.LoginResponse;
...
class ZequenceImsApplicationTests {
...
//    signup another user with duplicate email
	...
	public void shouldReturnLoginAttempts_WhenUserIsRegistered() {
		...
		assertThat(firstLoginAttempt.getCreatedAt()).isNotNull();
		assertThat(firstLoginAttempt.isSuccess()).isTrue();
	}
